class ContactSection extends HTMLElement {
  ...
  static get observedAttributes() {
    return [
      ...
      'st-title', 'd1', 't1', 'd2', 't2', 'd3', 't3', 'd4', 't4'
    ];
  }
  ...
  connectedCallback() {
    ...
    if (!this.hasAttribute('title-text')) this.setAttribute('title-text', 'Come worship with us.');
  ...
  render() {
    ...
    style.textContent = `
      ...
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .gold-rule { width: 50px; height: 2px; background: var(--copper); margin-bottom: 2rem; }
      ...
      .contact-info a:hover { color: var(--copper-light); }
      .contact-block { margin-bottom: 2.5rem; }

      .service-times { padding: 3rem; border: 1px solid rgba(246, 241, 235, 0.1); }
